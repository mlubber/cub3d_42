...
// int	process_element(t_whole *whole, char *line, int i)
// {
// 	int	result;
...
// 	if (result == 1)
// 	{
// 		print_error(whole, "Error, the key of line is not matched with any elements: ", line);
// 		return (1);
// 	}
// 	else if (result == 2)
// 	{
// 		print_error(whole, "Error, this key of line is duplicated: ", line);
// 		return (1);
// 	}
// 	return (0);
// }
...
// {
// 	if (line[i] && (line[i] == 'N' || line[i] == 'S' || line[i] == 'W' || line[i] == 'E' || line[i] == 'F' || line[i] == 'C'))
// 	{
